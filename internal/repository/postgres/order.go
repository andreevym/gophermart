...
func (r *OrderRepository) CreateOrder(ctx context.Context, order repository.Order) error {
...
func (r *OrderRepository) UpdateOrder(ctx context.Context, order repository.Order) error {
	if order.UploadedAt.IsZero() {
